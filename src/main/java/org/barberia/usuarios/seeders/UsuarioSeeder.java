...
public class UsuarioSeeder {
    ...
    public List<Usuario> seed() {
        ...
        //usuarios.add(usuarioService.create(adminUser));
        //usuarios.add(usuarioService.create(regularUser));


        //usuarios.add(usuarioService.create(clienteUser));
        //usuarios.add(usuarioService.create(clienteUser2));
        //usuarios.add(usuarioService.create(clienteUser3));


        //usuarios.add(usuarioService.create(empleadoUser));
        //usuarios.add(usuarioService.create(empleadoUser2));
        //usuarios.add(usuarioService.create(clienteUser2));
        //usuarios.add(usuarioService.create(empleadoUser3));
        return usuarios;
    }
